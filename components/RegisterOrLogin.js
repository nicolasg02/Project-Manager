...
function RegisterOrLogin() {
  ...
  return (
    <div className="h-screen flex justify-center items-center bg-gray-50">
      <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
        <div className="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white">
          {login ? 'Login to your account.' : 'Register an account.'}
        </div>
          ...
          <form onSubmit={handleFormAuth} autoComplete="off">
            ...
            <div className="flex items-center mb-6 -mt-4">
              <div className="flex ml-auto">
                <button className="bg-black text-white py-1 px-2 rounded text-sm">
                  Login as <span className="">guest</span>
                </button>
              </div>
            </div>
            <div className="flex w-full">
              <button
                type="submit"
                className="py-2 px-4  bg-purple-600 hover:bg-purple-700 focus:ring-purple-500 focus:ring-offset-purple-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded"
              >
        ...
        <div className="flex items-center justify-center mt-6">
          <button
            ...
            className="inline-flex items-center text-sm font-thin text-center text-gray-600 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white"
          >
            <span className="ml-2">
              {login
